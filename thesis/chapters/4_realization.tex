...
The singular values $S$ can be used to compute the share of variablity encoded in that corresponding mode $i$ with 
...
To fix these problems and also measure correlation, the secondary (or less) mode of the first scope in the historical simulation is used as the field to align to, since it was already shown that for the most part there is collapsing of the patters, and they look vaguely similar over the years of the simulation. 

...
Although there are some examples of visualizing uncertainity in scalar fields (or featuers thereof like iso contours), none of them provide an existing implementation, which greatly hinders the usability. 
...
After analyzing the different spatial patterns of the different variables (and especially IVT), 

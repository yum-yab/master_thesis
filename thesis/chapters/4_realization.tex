...
The latter approach was usid by  \citeauthorwork{vietinghoffdiss} (using the extreme points of the fields) and by \cite{sanyal_noodles_2010, whitaker_contour_2013} using iso contours.  

After analyzing the different spatial patterns of the different variables (and espiacally IVT), it was obvious that the seperation line between the positve and negative spatial patterns seems to be very pronounced, especially in the primary modes. 
...
It implements the idea of level crossing probabilities, similar to the work of \citeauthorwork{poethkow_approximate_2013}, but for iso contours and not for iso surfaces.

\textbf{Visualizing the Feature}

The most straight forward way of visualizing uncertain iso contours are spaghetti plots as used in the work of \citeauthorwork{sanyal_noodles_2010}, by simply drawing all the iso contours of the different members, usually in different colors. 

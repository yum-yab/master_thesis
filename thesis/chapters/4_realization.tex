...
Since the resolution is too high at some places (multiple observations per bin) and too low at others (no observation hitting the bin) like it is depicted in Figure~\ref{fig:hexbin overview} A and D, a sampling algorithm  was used to sample along the line.\todo{The problem here is: What gets depicted is in reference to the maximum amount of \enquote{line} in the hexbin containing most lines. How much is that? Nobody knows...} 
...
\todo{This is not very mathematical, and I think Ill run into problems once I analyze this approach mathematically...}
% \begin{itemize}

...
% \end{itemize}
%
\subsection{Challanges of Preprocessing}
...
But since the focu sof this thesis is monthly mean data, we are interested in the large scale structure of IVT and its connection to other variables, so rather large windows of 30 and 50 years were chosen, similar to \citeauthorwork{vietinghoff_visual_2021}.  
...
To fix these problems and also measure correlation of the secondary or lesser modes, the spatial pattern of the first scope in the historical simulation is used as the field to align to, since it was already shown that for the most part there is no collapsing of the patters, and they look vaguely similar over the years of the simulation. 

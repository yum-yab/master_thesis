...
\textbf{M1 Generate the patterns of moisture transport}
...
\textbf{M2 Study the relationships with other variables and related data}

To get a grasp of the meaning of the moisture transport, the connection or relation to other variables (see Section~\ref{sec:Position of this Thesis}) needs to be explored. 
This can be achieved by analyzing the connection of moisture transport patterns with precipitation or the activity of the North Atlantic Oscillation. 

\textbf{M3 Visualize the results}

The results of the previous steps need to visualized so that they can properly be interpreted. 

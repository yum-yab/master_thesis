...
While the Network Common Data Format is an abstraction for storing multidimensional data, NetCDF itself is an implementation of said abstraction with a data format and a library supporting that data format. 

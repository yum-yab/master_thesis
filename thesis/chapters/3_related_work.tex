...
Although most found related work uses EOF analysis, \citeauthor{teale_patterns_2020} employ an approach using Self Organizing Maps (SOMs) to detect patterns of moisture transport in the eastern United States.
...
\textbf{Release Year} & \textbf{Pattern extraction} & \textbf{Area of Interest} & \textbf{Timescope} & \textbf{Time Resolution} & \textbf{Studied Season} & \textbf{Variable used for EOF} \\
2020 \cite{teale_patterns_2020}                 & SOMs                        & USA east                  & 1979 to 2017       & daily                    & all year                & IVT norm                       \\
2022  \cite{ayantobo_integrated_2022}                & EOF                         & China                     & 1979 to 2010       & daily                    & all year                & IVT norm                       \\
1982   \cite{salstein_modes_1983}               & EOF                         & Northern hemishpere       & 1958 to 1973       & monthly/yearly           & all year                & IWV, IVT\_u IVT\_v, combined   \\
2003  \cite{fernandez_analysis_2003}                & EOF                         & mediterranian sea         & 1948 to 1996       & 6hr                      & DJF                     & P                              \\
2005 \cite{zhou_atmospheric_2005}                 & EOF                         & China                     & 1951 to 1999       & monthly                  & JJA                     & P                              \\
2018 \cite{guirguis_circulation_2018}                 & EOF                         & USA (west coast)          & 1948 to 2017       & daily                    & NDJF                    & IVT norm (assumed)             \\
2015 \cite{kim_ensos_2015}                 & EOF                         & western USA               & 1979 to 2010       & 6hr                      & DJF                     & IVT norm (assumed)             \\
2018 \cite{zou_interdecadal_2018}                 & EOF                         & TEIOWP                    & 1961 to 2015       & monthly                  & JJA                     & IVT                            \\
2020 \cite{zou_investigating_2020}                 & EOF                         & TEIOWP                    & 1958 to 2018       & 6hr/monthly              & JJA                     & Integrated Water Vapor Sink    \\
...
\end{table}
\todo{Check again, fill gaps and improve Variable used for eof (maybe also add here compared vars, like SST and so on)}
...
In terms of uncertainty visualization, most of the presented approaches could be quite useful in this thesis: The animated Perlin noise from \cite{coninx_visualization_2011} could be used to show the uncertainty in the scalar fields, while the ribbons and contour boxplots can be used to represent contours in the patterns (see Section \todo{ref to feature selection section} for the decision of the feature extraction). 
...
While it is easy to compute and visualize the comparison of EOF patterns of different variables, \citeauthorwork{dommenget_cautionary_2002} provide a good example why EOF patterns are hard to interpret and link to actual physical modes. 

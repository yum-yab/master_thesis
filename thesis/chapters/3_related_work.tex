...
In terms of uncertainity visualization, most of the presented approaches could be quite useful in this thesis: The animated Perlin noise from \cite{coninx_visualization_2011} could be used to show the uncertainity in the scalar fields, while the ribbons and contour boxplots can be used to represent contours in the patterns (see Section \todo{ref to feature selection section} for the descision of the feature extraction). 
Unfortunately, none of these algorithms is available as a library \todo{double check if this is true}, which hinders applicance to a great extent. 
